...
4. An adjacent Backspan UG extracts only the first-line reason from the adjacent pole's editable UG template; its riser is 12 inches below primary Proposed and uses only a direction imported from Make Ready/IO.
